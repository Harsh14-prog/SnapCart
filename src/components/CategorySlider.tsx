'use client'
import {
  Apple, Baby, Box, ChevronLeft, ChevronRight, Coffee, Cookie,
  Flame, Heart, Home, Milk, Wheat
} from 'lucide-react'
    ...
    >
      ...
      {showLeft && (
        <button
          ...
          bg-white/80 backdrop-blur shadow-lg hover:shadow-xl
          hover:scale-110 rounded-full w-10 h-10
        ...
        {categories.map((cat) => {
          ...
          return (
            <motion.div
              ...
              className={`group
                min-w-37.5 md:min-w-45
                flex flex-col items-center justify-center
                rounded-2xl ${cat.color}
            ...
            >
              ...
              <div className='relative flex flex-col items-center justify-center p-5'>
                <Icon className='w-10 h-10 text-green-700 mb-3 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6' />
